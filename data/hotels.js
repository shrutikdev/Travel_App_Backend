// Import the 'uuid' library and rename the 'v4' method to 'uuid' using destructuring
const { v4: uuid } = require('uuid');

// Define an object named 'hotels'
const hotels = {
    // Within 'hotels', define a 'data' property that is an array of hotel objects
    "data": [
        // Each hotel object has various properties such as 'id', 'name', 'category', etc.
        {
            // Generate a unique ID for the hotel using the 'uuid' library
            id: uuid(),
            // ... (other properties for the hotel)
